...
class InternalErrorExceptionTest {
    ...
    private InternalErrorException internalErrorExceptionUnderTest;

    @BeforeEach
    void setUp() {
        internalErrorExceptionUnderTest = new InternalErrorException(ErrorInfo.UNEXPECTED_ERROR, "args");
    }
